...
MODEL              = Date0501_QuadModel
MODULES            = Date0501_QuadModel_acc_data.c HostLib_Network.c HostLib_rtw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = Date0501_QuadModel.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/R2015a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/R2015a
MASTER_ANCHOR_DIR  = 
START_DIR          = C:/ThiagoVR/LivingRoom
...
MODELLIB                  = Date0501_QuadModellib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/accel/Date0501_QuadModel \
	-I$(START_DIR) \
